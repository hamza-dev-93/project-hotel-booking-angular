...
import { TunisianWeddingComponent } from './weddings/tunisian-wedding/tunisian-wedding.component';
import { EsternsWeddingComponent } from './weddings/esterns-wedding/esterns-wedding.component';
...
@NgModule({
  declarations: [
    ...
    ExcursionsComponent,
    WeddingsComponent,
    TunisianWeddingComponent,
    EsternsWeddingComponent,
